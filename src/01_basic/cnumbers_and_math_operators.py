...
"""
An easy way to remember the operator precedence is to remember the word pemdas, 
which is an acronym for: parentheses, exponents, multiplication, division, addition, subtraction.
"""
