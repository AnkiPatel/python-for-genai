...
# Assigning unique IDs to participants from 1 to 10
for participant_id in range(1, 11):  # range(start, stop) -> stop is exclusive
...
# Generate a list of numbers from 10 to 19
