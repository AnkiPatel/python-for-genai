...
# here temp, humidity and wind_speed are parameters to function 
...
# you have to take care about the order when you are just passing the value
# here 25, 60 and 8 are arguments to function
display_weather(25, 60, 8)
