...
print(f'Total cost for this message: {total_cost}') #output:Total cost for this message: 0.123

# Formatting a floating-point number to 4 decimal places
total_cost = f'{token_used * cost_per_token:.4f}'
print(f'Total cost for this message: {total_cost}') #Output:Total cost for this message: 0.1230
